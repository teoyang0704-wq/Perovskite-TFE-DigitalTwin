...
- [ ] ref 2  ACS Mater. Au 2022 리뷰 — 저자·권·페이지
- [ ] ref 3  Lee et al., Adv. Energy Mater. — 권·호·페이지 (★Fig.2d 데이터 논문)
...
- [ ] ref 4  Choi et al., SEMSC 2018 — 전체 서지 + 측정법(§BM013 quality B→A)
- [ ] ref 5  Ramos et al., Sustain. Energy Fuels 2018 — 페이지
- [ ] ref 6  Singh et al., SEMSC 205, 110289 — 확인만
- [ ] ref 9  Kiese et al., Thin Solid Films 2019 — 저자·권·페이지
- [ ] ref 12 GaAs NSGA-II, Solar Energy 2021 — 저자·권
- [ ] ref 14 AutoML PSC DT, J. Clean. Prod. 2024 — 저자·권 (★정독 대상)
- [ ] ref 15 TFE FOM 2025 — 저널 확정(Thin Solid Films?)·저자 (★정독 대상)
- [ ] ref 17 Rossi & Nulman, J. Appl. Phys. 74 (1993) — 권·페이지
- [ ] ref 18 da Silva Sobrinho, JVST A 18 (2000) — 페이지
- [ ] ref 22 Frisch, J. Phys. Chem. 61 (1957) — 페이지
